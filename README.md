...
When updating, we need to customize these name so U-App can properly identify and display what we want:

Was: => Should be:

Chrome Desktop => Chrome
Chrome In-App => Chrome Webview
Chrome Android => Chrome Mobile
Facebook App => Facebook
Safari iOS => Mobile Safari
Apple News App => Apple News
Messenger App => Facebook Messenger
Firefox Dekstop => Firefox
